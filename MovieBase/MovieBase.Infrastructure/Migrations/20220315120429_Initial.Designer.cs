...
namespace MovieBase.Infrastructure.Migrations
{
    ...
    [Migration("20220315120429_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MovieBase.Core.Models.MovieStar", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MovieBase.Core.Models.Award", b =>
                {
                    b.HasOne("MovieBase.Core.Models.MovieStar", null)
                        .WithMany("Awards")
                        .HasForeignKey("MovieStarId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("MovieBase.Core.Models.CriticReview", b =>
                {
                    b.HasOne("MovieBase.Core.Models.Movie", null)
            ...
            modelBuilder.Entity("MovieBase.Core.Models.Filmography", b =>
                {
                    b.HasOne("MovieBase.Core.Models.MovieStar", null)
                        .WithOne("Filmography")
                        .HasForeignKey("MovieBase.Core.Models.Filmography", "MovieStarId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("MovieBase.Core.Models.Movie", b =>
                {
                    b.HasOne("MovieBase.Core.Models.MovieStar", "Director")
                        .WithMany()
            ...
            modelBuilder.Entity("MovieBase.Core.Models.PersonalDetails", b =>
                {
                    b.HasOne("MovieBase.Core.Models.MovieStar", null)
                        ...
                        .HasForeignKey("MovieBase.Core.Models.PersonalDetails", "MovieStarId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
